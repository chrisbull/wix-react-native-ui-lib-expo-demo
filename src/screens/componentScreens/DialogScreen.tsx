...
import { Button, Colors, Dialog, Text, View } from "react-native-ui-lib"; // eslint-disable-line
...
class DialogScreen extends Component {
  ...
  public renderDialogContent(dialogIndex, extraProps) {
    return (
  ...
  public render() {
    ...
    return (
      <View flex bg-dark80 padding-12 center>
        ...
        />
        <Button marginT-20 size={"small"} label="show dialog in RNN overlay" onPress={this.showOverlay} />
